...
describe('Closure Leak test', function () {
  ...
  before(async function () {
    console.log = () => {};
    fs.writeFileSync(join(process.cwd(), "guest_app_closure_test_leak.js"), closure_leak_test, { encoding: 'utf-8' });

    driver = await NodeDriver.Launch(NopLog, [], false, join(process.cwd(), "guest_app_closure_test_leak.js"));
