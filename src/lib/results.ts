...
export default class BLeakResults implements IBLeakResults {
  ...
  public static FromJSON(br: IBLeakResults): BLeakResults {
    return new BLeakResults(
      br.leaks.map(leakRootFromJSON),
      br.stackFrames,
      br.sourceFiles,
      br.heapStats,
      br.rankingEvaluation
    );
  }
  ...
  constructor(
    ...
    public readonly rankingEvaluation: RankingEvaluation = {
      leakShare: [],
